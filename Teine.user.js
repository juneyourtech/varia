...
// @include http://2ndrun.tv/cspan/*
// @include http://2ndrun.tv/fox-news*
// @include     https://2ndrun.tv/cnn*
// @include     *.2ndrun.tv/bbc-news/*
// @include     https://2ndrun.tv/msnbc/*
// @include *.2ndrun.tv/cspan/*
// @include     https://tunein.com/*
// @include     http://retubeit.tv/cnn*
// @include http://retubeit.tv/fox-news*
...
/* background-image */
GM_addStyle("DIV.entry-content > DIV {background-repeat:no-repeat !important; background-position:left top !important; background-size:100% 100% !important;}");
...
GM_addStyle("DIV#wpfront-scroll-top-container > IMG {width:35px !important; height:69px !important; opacity:0.3; background-color:rgba(0,0,0,0.5); }");
/* width: 52x100 > 36x69
...
GM_addStyle("@media only screen and (max-width:980px) { HTML.js .main-nav {display:block;}  NAV.main-nav LI A {padding:0px; padding-left:2px; padding-right:8px; font-size:80%; } }");
/* L., 25.05.2019. */
/*
...
GM_addStyle("DIV.header-sub {padding:0px; padding-bottom:1px;}");
/* after header menu | L., 25.05.2019. */

/* CNN logo container above video and ticker */
GM_addStyle("ARTICLE.post-651 H1.entry-title.page-title {margin-bottom:0px; text-indent:0px; background-position:top right; line-height:1.1; height:40px; text-align:center;}");
/* L., 25.05.2019.
...
/* GM_addStyle("DIV.wptu-ticker-block:before {content:\'Hover for ticker news\'; display:inline; color:white;}"); */
/* rem 21,5,2019 */
...
GM_addStyle("DIV.code-block-11 > CENTER > A[href*=\'amazon\'] > IMG.size-full {width:100px; height:44px; margin-top:0px; margin-bottom:0px;}"); /* original: 300x133px to 100x44px */
/* 28.05.2018
   02.09.2018: Imma show you a real nice selector:
SPAN.likebtn-wrapper ~ CENTER > A[href*=\'amazon\'] > IMG.size-full */

/* the P after that */
GM_addStyle("SPAN.likebtn-wrapper ~ CENTER ~ P {display:none; margin-bottom:0px;}");
/* 28.05.2018 */

/* the P after that */
GM_addStyle("SPAN.likebtn-wrapper ~ CENTER ~ P ~ P {display:none; margin-bottom:0px;}");
/* 28.05.2018 */
